...
import cableTvServiceRoutes from "./routes/cableTvService.routes.js";
...
app.use("/api/v1/services", cableTvServiceRoutes);
app.use("/api/v1/services", dataServiceRoutes);
app.use("/api/v1/services", electricityServiceRoutes);
