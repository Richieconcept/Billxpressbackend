...
export const passwordResetTemplate = ({ username, otp }) => {
  ...
  return {
    ...
    textContent: `Hi ${safeUsername}, your ${BRAND.name} password reset code is ${otp}. This code expires in 10 minutes. If you did not request this, please contact support immediately.`,
    htmlContent: billxpressEmailLayout({
      title: "Reset your password",
      preheader: `Your ${BRAND.name} password reset code is ${otp}`,
      ...
      `,
      footerNote:
        `This code expires in 10 minutes. If you did not request a password reset, please contact ${BRAND.name} support immediately.`,
    }),
  };
};
